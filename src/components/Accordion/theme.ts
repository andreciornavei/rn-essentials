...
export const AccordionTheme = (theme: Theme) => ({
    themes: (): AccordionThemes => ({
        "primary": {
            ...
            placeholder: { color: theme.color.white },
        ...
        "warning": {
            ...
            placeholder: { color: theme.color.dark },
        ...
        "link": {
            ...
            placeholder: { color: theme.color.link },
        ...
        "outline-primary": {
            ...
            placeholder: { color: theme.color.primary },
        ...
        "outline-light": {
            ...
            placeholder: { color: theme.color.light },
